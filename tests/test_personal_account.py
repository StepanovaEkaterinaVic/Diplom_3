...
class TestAccountPage:
    ...
    def test_account_page_jump(self, login):
        ...
        assert account_page.show_personal_account_window() == Message.PROFILE
    ...
    def test_account_history_visibility(self, login):
        ...
        main_page.go_to_personal_account()
        assert account_page.show_personal_orders_history() == Message.PAGE
    ...
    def test_log_out_from_account(self, login):
        ...
        assert login_page.show_authorization_form() == Message.INPUT
